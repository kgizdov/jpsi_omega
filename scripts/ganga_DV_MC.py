...
if mode == 'norm':
	script='/afs/cern.ch/work/k/kgizdov/jpsi_omega/python/DV_Lb2chicpK_norm_' + year + '_MC.py'
else:
	script='/afs/cern.ch/work/k/kgizdov/jpsi_omega/python/DV_B2psiomega_' + year + '_MC.py'
