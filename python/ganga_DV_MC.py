...
if mode == 'norm':
	script='/afs/cern.ch/user/k/kgizdov/b2psiomega/python/DV_Lb2chicpK_norm_' + year + '_MC.py'
else:
	script='/afs/cern.ch/user/k/kgizdov/b2psiomega/python/DV_B2psiomega_' + year + '_MC.py'
...
DV = DaVinci()
DV.version = 'v38r1p1'  # latest is v38r1p1, was v36r1
...
j = Job(
  name           = job_name,
  application    = DV,
  splitter       = SplitByFiles(filesPerJob = 2), #set to 1 for debugging, was 20
  inputdata      = data,
