...
SBMASSPLOTS = ["plots/comparison/%s.pdf" % (i) for i in ["B_M_SB", "JPsi_M_SB", "Omega_M_SB", "Pi0_M_SB"]]
SBPTMASSPLOTS = ["plots/comparison/%s_HighPTcut.pdf" % (i) for i in ["B_M_SB", "JPsi_M_SB", "Omega_M_SB", "Pi0_M_SB"]]

# B0 comparison plots params
B_VARS =     ["%s" % (i) for i in ["B0_M", "B0_DTF_MASS_constr", "B0_PT", "B0_DTF_CTAU", "B0_DTF_CHI2NDOF", "B0_ETA", "B0_IPCHI2_OWNPV", "B0_VCHI2NDOF"]]
B_WRANGE =   ["%s" % (i) for i in ["-l 5100 -u 5600", "-l 5100 -u 5600", "-l 14500 -u 25000", "-l 0.150 -u 1", "-l 0 -u 5", "-l 2 -u 6", "-l 0 -u 10", "-l 0 -u 5"]]
...
B_PT_PLOTS = ["plots/comparison/B/%s_HighPTcut.pdf" % (i) for i in B_VARS]
...
JP_PT_PLOTS = ["plots/comparison/JP/%s_HighPTcut.pdf" % (i) for i in JP_VARS]
...
MU_PT_PLOTS = ["plots/comparison/MU/%s_HighPTcut.pdf" % (i) for i in MU_VARS]
...
OM_PT_PLOTS = ["plots/comparison/OM/%s_HighPTcut.pdf" % (i) for i in OM_VARS]
...
PI_PT_PLOTS = ["plots/comparison/PI/%s_HighPTcut.pdf" % (i) for i in PI_VARS]
...
PZ_PLOTN =    ["plots/comparison/PZ/%s" % (i) for i in PZ_VARS]
PZ_PLOTS =    ["plots/comparison/PZ/%s.pdf" % (i) for i in PZ_VARS]
PZ_PT_PLOTN = ["plots/comparison/PZ/%s_HighPTcut" % (i) for i in PZ_VARS]
PZ_PT_PLOTS = ["plots/comparison/PZ/%s_HighPTcut.pdf" % (i) for i in PZ_VARS]
